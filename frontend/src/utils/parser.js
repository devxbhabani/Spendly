...
export function parseTransactionSMS(smsText) {
	...
	//  Amount Extraction: Rs., INR, ₹ prefix handling
	...
	// Merchant / VPA Identifier following 'to', 'at', 'vpa', 'by', 'for'
	let merchant = null;
	...
	// Account Reference (e.g. A/c XX4723 -> **4723)
	...
	// Available Balance (e.g. Avl Bal Rs.42.39)
	...
	// Timestamp / Date extraction (Handles DD-MM-YYYY, DD/MM/YYYY, or standard)
